...
SCHEMAS = {
    ...
    "schema://deviation-analysis/input@1": _load("input.schema.json"),
    "schema://deviation-analysis/result@1": _load("output.schema.json"),
}
STRATEGIES = {"strategy://deviation-analysis/execute@6": _load("strategy.json")}
