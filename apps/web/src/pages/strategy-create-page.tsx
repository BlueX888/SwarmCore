...
import type { CanvasCapabilitySelection, Diagnostic } from "@/api/types";
import { StrategyEditor } from "@/components/strategy/strategy-editor";
import { EMPTY_EDITOR_STATE, cloneSpec, createBlankSpec, normalizeEditorState, type EditorState } from "@/components/strategy/strategy-editor-model";
...
export function StrategyCreatePage({ standalone = false }: { standalone?: boolean }) {
  ...
  const [editorState, setEditorState] = React.useState<EditorState>(() => normalizeEditorState(initial?.editorState ?? EMPTY_EDITOR_STATE));
  ...
  return <div className="min-w-0 space-y-6">
    ...
    <Card><CardContent className="space-y-5 pt-5">
      ...
      <StrategyEditor
        ...
        onSpecChange={(value) => { setSpec(value); setMessage(""); }}
